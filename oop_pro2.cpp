...
void login :: getid()
	...
	void Detail :: displaydetail()
	{
        ...
        cout << "|F-Class" << "\t" << "|F-Class Fare" << "\t" << "|S-Class" << "\t" << "|S-Class Fare" << "\t" << "|sleeping " << "\t" << "|Female section" << "\t";
        cout << "|Day" << "-" << "Month" << "-" << "Year" << "\n";
	...
	void reser :: getresdet()
	{
        ...
        for (int i = 0; i < bag; i++)
        {
            ...
            cout << "your bag id is:" << (rand() % (1 - 500)) + 1 << "\n";
        }
        ...
        if (meal == 'y')
        {
            ...
            cout << " 1. kids meal ( orange juice + sandwich + fries )  ";
            cout << " \n 2. adults meal ( coffee / tea / cola + sandwich + fries )";
            cout << "\n 3. family meal ( kids meal + adults meal ) " << "\n";
            cin >> ch;
